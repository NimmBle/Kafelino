    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(8972), "Тази изключителна партида Гейша идва от прочутата ферма Volcán Azul, която редовно се отличава като победител в конкурса Cup of Excellence Costa Rica. Обработена чрез натурален метод, тази партида разкрива елегантността и сложността, които правят Гейша толкова ценен сорт. Ароматът е фин и цветен, водещ към живи вкусове на жасмин и сочна папая. Ябълково-цитрусова киселинност придава свеж баланс, докато естествената сладост се запазва дълго, оставяйки изтънчен и продължителен вкус на кафява захар.", "https://kometa.coffee/wp-content/uploads/2024/03/vulkan-azul-geisha.jpg", false, "Вулкан Азул | Гейша", 26.00m, 95, 2 },
                    { 2, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9046), "Тази уникална партида е резултат от иновативния подход на Хайро Арсила, който използва плодова ферментация за обогатяване на вкусовия профил. Кафето впечатлява с нотки на праскова, кокос и ванилия, създавайки комплексен и запомнящ се вкус.", "https://kometa.coffee/wp-content/uploads/2024/03/jairo-arsila-fruit-fermentation.jpg", false, "Хайро Арсила | Плодова ферментация", 24.00m, 120, 4 },
                    { 3, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9050), "Отгледано в региона Уиля, Колумбия, това кафе от сорта Таби предлага богат вкус с изразени нотки на боровинки, грозде и натурален шоколад. Идеално за любителите на плодови и сладки профили.", "https://kometa.coffee/wp-content/uploads/2024/03/alonso-bustos-tabi.jpg", false, "Алонсо Бустос | Таби", 32.00m, 75, 3 },
                    { 4, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9063), "Тази партида от региона Гуджи в Етиопия се отличава с флорални аромати и вкусове на жасмин, праскова и карамел. Перфектен избор за тези, които търсят елегантно и балансирано кафе.", "https://kometa.coffee/wp-content/uploads/2024/03/hambela-guji-ethiopia.jpg", false, "Хамбела Гуджи, Етиопия", 28.00m, 105, 1 },
                    { 5, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9068), "Кафе от региона Матагалпа в Никарагуа, което впечатлява с плътно тяло и вкусови нотки на карамел, зряла череша и черен чай.", "https://kometa.coffee/wp-content/uploads/2024/03/finca-san-isidro-catuai.jpg", false, "Финка Сан Исидро | Катуай", 19.00m, 85, 4 },
                    { 6, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9071), "Традиционно кенийско кафе с интензивен аромат и вкусове на касис, цитрусови плодове и черен чай. Отличен избор за филтърно приготвяне.", "https://kometa.coffee/wp-content/uploads/2024/03/kenya-karimiru-sl28-sl34.jpg", false, "Кения Каримиру | SL28 & SL34", 28.00m, 95, 3 },
                    { 7, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9078), "Кафе от планините на Гватемала с комплексен профил и вкусове на какао, карамел и портокалова кора.", "https://kometa.coffee/wp-content/uploads/2024/03/guatemala-junacan-pacamara.jpg", false, "Гватемала Хунакан | Пакмара", 25.00m, 110, 2 },
                    { 8, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9081), "Традиционно бразилско кафе със сладък и балансиран вкус на шоколад, лешник и карамел. Перфектно за еспресо.", "https://kometa.coffee/wp-content/uploads/2024/03/brazil-santos-natural.jpg", false, "Бразилия Сантош | Натурален", 18.00m, 90, 1 },
                    { 9, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9093), "Легендарно кафе от региона Йиргачеф в Етиопия, което предлага флорални нотки, цитрусови плодове и медена сладост.", "https://kometa.coffee/wp-content/uploads/2024/03/ethiopia-sidamo-yirgacheffe.jpg", false, "Етиопия Сидамо | Yirgacheffe", 26.00m, 80, 3 },
                    { 10, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9097), "Плодово и сладко кафе с нотки на сушена слива, лешник и мед. Един от най-добрите примери за африканско кафе.", "https://kometa.coffee/wp-content/uploads/2024/03/rwanda-gaciziro-bourbon.jpg", false, "Руанда Гацизиро | Бърбън", 27.00m, 115, 4 },
                    { 11, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9102), "Едно от най-изисканите кафета в света – Панамската Гейша от региона Бокете е известна със своите интензивни флорални аромати, цитрусови нотки и копринена текстура. Сладостта и продължителният послевкус правят това кафе истинско удоволствие.", "https://kometa.coffee/wp-content/uploads/2024/03/panama-boquete-geisha.jpg", false, "Панама Бокете | Гейша", 30.00m, 105, 1 },
                    { 12, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9106), "Кафе от региона Гайо в Суматра, което предлага пикантни и земни нотки с намек за канела, тъмен шоколад и индийско орехче. Балансирано тяло и дълъг, сладък послевкус.", "https://kometa.coffee/wp-content/uploads/2024/03/indonesia-sumatra-gayo.jpg", false, "Индонезия Суматра | Gayo", 22.50m, 95, 3 },
                    { 13, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9110), "Класическо йеменско кафе с дълбок профил – нотки на тъмен шоколад, черен чай и сушени плодове. Истинско историческо кафе с автентичен вкус.", "https://kometa.coffee/wp-content/uploads/2024/03/yemen-mokha-matari.jpg", false, "Йемен Мокха Матари", 32.00m, 85, 2 },
                    { 14, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9114), "Уникално кафе от планините на Уганда със сочен плодов профил и нотки на кайсия, шоколад и карамфил. Отличава се със свежа киселинност и кремообразно тяло.", "https://kometa.coffee/wp-content/uploads/2024/03/uganda-bugisu-sl14-sl28.jpg", false, "Уганда Бугису | SL14 & SL28", 23.50m, 115, 4 },
                    { 15, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9118), "Отгледано в региона Маркала, това кафе предлага приятен баланс между сладост и киселинност, с нотки на мед, орех и млечен шоколад.", "https://kometa.coffee/wp-content/uploads/2024/03/honduras-marcala-catuai.jpg", false, "Хондурас Маркала | Катуай", 21.50m, 100, 1 },
                    { 16, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9134), "Кафе от региона Серрадо в Бразилия със сладък и плътен профил. Вкусове на лешник, шоколад и карамел правят това кафе отличен избор за еспресо.", "https://kometa.coffee/wp-content/uploads/2024/03/brazil-cerrado-bourbon.jpg", false, "Бразилия Серрадо | Бурбон", 19.00m, 110, 2 },
                    { 17, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9201), "Средно изпечено перуанско кафе със сладък и мек вкус. Нотки на тъмен шоколад, бадем и сладка череша. Подходящо за всички методи на приготвяне.", "https://kometa.coffee/wp-content/uploads/2024/03/peru-san-ignacio-catuai.jpg", false, "Перу Сан Игнасио | Катуай", 23.00m, 90, 3 },
                    { 18, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9207), "Кафе от един от най-добрите райони в Коста Рика, отличаващо се с карамелена сладост, нотки на ванилия и цитрусово усещане. Перфектно за филтърно кафе.", "https://kometa.coffee/wp-content/uploads/2024/03/costa-rica-tarrazu-caturra.jpg", false, "Коста Рика Тарразу | Катура", 24.50m, 120, 4 },
                    { 19, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9210), "Фина селекция от сорта Пакамаара, отличаваща се с плодова сладост и нотки на зелена ябълка, мед и лимон. Изключително комплексно и балансирано кафе.", "https://kometa.coffee/wp-content/uploads/2024/03/el-salvador-santa-ana-pacamara.jpg", false, "Ел Салвадор Санта Ана | Пакамаара", 26.00m, 80, 2 },
                    { 20, "KOMETA", new DateTime(2025, 3, 18, 13, 8, 26, 368, DateTimeKind.Local).AddTicks(9214), "Високопланинско кафе с богата киселинност и сложен ароматен профил. Нотки на кайсия, мед и черен чай го правят предпочитан избор за филтърно кафе.", "https://kometa.coffee/wp-content/uploads/2024/03/colombia-tolima-castillo.jpg", false, "Колумбия Толуима | Кастийо", 25.00m, 75, 1 }
                });
