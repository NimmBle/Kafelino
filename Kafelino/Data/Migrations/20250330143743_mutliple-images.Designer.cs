...
namespace Kafelino.Data.Migrations
{
    ...
    [Migration("20250330143743_mutliple-images")]
    partial class mutlipleimages
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kafelino.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = 1,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1262),
                        ...
                        new
                        {
                            ProductId = 2,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1359),
                        ...
                        new
                        {
                            ProductId = 3,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1364),
                        ...
                        new
                        {
                            ProductId = 4,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1369),
                        ...
                        new
                        {
                            ProductId = 5,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1374),
                        ...
                        new
                        {
                            ProductId = 6,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1379),
                        ...
                        new
                        {
                            ProductId = 7,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1385),
                            Description = "Кафе от планините на Гватемала с комплексен профил и вкусове на какао, карамел и портокалова кора.",
                            ImageUrls = "[\"https://kometa.coffee/wp-content/uploads/2024/03/guatemala-junacan-pacamara.jpg\"]",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ProductId = 8,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1389),
                            Description = "Традиционно бразилско кафе със сладък и балансиран вкус на шоколад, лешник и карамел. Перфектно за еспресо.",
                            ImageUrls = "[\"https://kometa.coffee/wp-content/uploads/2024/03/brazil-santos-natural.jpg\"]",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ProductId = 9,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1395),
                            ...
                            ImageUrls = "[\"https://kometa.coffee/wp-content/uploads/2024/03/ethiopia-sidamo-yirgacheffe.jpg\"]",
                            IsDeleted = false,
                        ...
                        new
                        {
                            ProductId = 10,
                            Brand = "KOMETA",
                            CreatedOn = new DateTime(2025, 3, 30, 17, 37, 42, 674, DateTimeKind.Local).AddTicks(1400),
                            Description = "Плодово и сладко кафе с нотки на сушена слива, лешник и мед. Един от най-добрите примери за африканско кафе.",
                            ImageUrls = "[\"https://kometa.coffee/wp-content/uploads/2024/03/rwanda-gaciziro-bourbon.jpg\"]",
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Kafelino.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "fa7b8147-d0b4-4d59-b4a8-64b26a6fc0e1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "37b1b2a0-d0d8-4424-a9e7-161ca55ae5b1",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEMFnngNw5E/Usd/AKKr6Oj0v+42wv7Yr3b817icSD6cvTmk1sYOk6RnegYGBiFgXoA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "3711d093-bf76-4aae-a721-85adc49faf8c",
                            TwoFactorEnabled = false,
                            UserName = "admin@kafelino.com"
                        },
                        new
                        {
                            Id = "97a12f0f-d3a8-45e2-91cc-1d02f0a57854",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "fc0d34a2-deed-4137-8d63-ca198260755b",
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEA54qlsPWQFtbNCockjpxPNeGg31TAuhl80JZN8mijTNXmSDoBgFa/JZsa9Q/l90wQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "134835a9-ba0f-4f76-9d50-829eaa2229a0",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "4e20463a-91b5-44db-b0f8-6d4b8e6ffbe8",
                            ConcurrencyStamp = "4e20463a-91b5-44db-b0f8-6d4b8e6ffbe8",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "fa7b8147-d0b4-4d59-b4a8-64b26a6fc0e1",
                            RoleId = "4e20463a-91b5-44db-b0f8-6d4b8e6ffbe8"
                        });
                });
