...
namespace Kafelino.Data.Migrations
{
    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ProductTasteNote",
                columns: table => new
                {
                    ProductsProductId = table.Column<int>(type: "int", nullable: false),
                    TasteNotesTasteNoteId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductTasteNote", x => new { x.ProductsProductId, x.TasteNotesTasteNoteId });
                    table.ForeignKey(
                        name: "FK_ProductTasteNote_Products_ProductsProductId",
                        column: x => x.ProductsProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTasteNote_TasteNotes_TasteNotesTasteNoteId",
                        column: x => x.TasteNotesTasteNoteId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTasteNote_TasteNotesTasteNoteId",
                table: "ProductTasteNote",
                column: "TasteNotesTasteNoteId");
